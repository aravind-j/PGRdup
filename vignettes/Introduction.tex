...
\hypersetup{unicode=true,
            ...
            pdfauthor={J. Aravind1, J. Radhamani1, Kalyani Srinivasan1, B. Ananda Subhash2 and R. K. Tyagi1},
            pdfborder={0 0 0},
            breaklinks=true}
...
\setlength{\droptitle}{-2em}
  \title{An Introduction to \textbf{PGRdup} package}
  \pretitle{\vspace{\droptitle}\centering\huge}
  \posttitle{\par}
  \author{J. Aravind\textsuperscript{1}, J. Radhamani\textsuperscript{1}, Kalyani
Srinivasan\textsuperscript{1}, B. Ananda Subhash\textsuperscript{2} and
R. K. Tyagi\textsuperscript{1}}
...
\includegraphics{imgs/PGRdup.png}
...
(Knüpffer 1988; Knüpffer, Frese, and Jongen 1997) from the data frame of
a PGR passport database based on the fields(columns) specified in the
argument \texttt{fields} along with the keyword frequencies and gives
the output as a list of class \texttt{KWIC}. The first element of the
vector specified in \texttt{fields} is considered as the primary key or
...
\item
  ...
  function \texttt{DoubleMetaphone}, (Philips 2000), to identify
...
Loo 2014), which is made use of here for string matching.
...
\includegraphics{Introduction_files/figure-latex/unnamed-chunk-41-1.pdf}
...
\includegraphics{Introduction_files/figure-latex/unnamed-chunk-56-1.pdf}
...
\includegraphics{Introduction_files/figure-latex/unnamed-chunk-57-1.pdf}
...
[4] diagram_1.6.4      shape_1.4.4        PGRdup_0.2.3.4    

loaded via a namespace (and not attached):
 [1] stringdist_0.9.4.7   slam_0.1-42          purrr_0.2.4         
 [4] colorspace_1.3-2     testthat_2.0.0       htmltools_0.3.6     
 [7] yaml_2.1.18          XML_3.98-1.10        rlang_0.2.0         
[10] pkgbuild_1.0.0       pkgdown_0.1.0.9000   pillar_1.2.1        
[13] withr_2.1.2          plyr_1.8.4           stringr_1.3.0       
[16] munsell_0.4.3        commonmark_1.4       gtable_0.2.0        
[19] devtools_1.13.5      evaluate_0.10.1      memoise_1.1.0       
[22] labeling_0.3         knitr_1.20           callr_2.0.3         
[25] highlight_0.4.7.2    parallel_3.4.3       curl_3.1            
[28] highr_0.6            Rcpp_0.12.16         backports_1.1.2     
[31] scales_0.5.0         desc_1.1.1           pkgload_1.0.0       
[34] jsonlite_1.5         debugme_1.1.0        fs_1.2.2            
[37] microbenchmark_1.4-4 ggplot2_2.2.1        digest_0.6.15       
...
[49] whisker_0.3-2        pkgconfig_2.0.1      MASS_7.3-49         
[52] data.table_1.10.4-3  xml2_1.2.0           assertthat_0.2.0    
[55] rmarkdown_1.9.8      rematch_1.0.1        roxygen2_6.0.1      
[58] httr_1.3.1           rstudioapi_0.7       R6_2.2.2            
[61] igraph_1.2.1         compiler_3.4.3      
\end{verbatim}
