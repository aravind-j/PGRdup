...
switch(out_type,
    html = {cat("<p>ICAR-National Bureau of Plant Genetic Resources, New Delhi, India.</p>
	
<p>Centre for Development of Advanced Computing, Thiruvananthapuram, Kerala, India.</p>")},
...
\begin{wrapfigure}{r}{0.35\textwidth}
  \vspace{1cm}
  \begin{center}
    \includegraphics[width=0.33\textwidth]{`r system.file("extdata", "PGRdup v2.png", package = "PGRdup")`}
  \end{center}
  \vspace{-1.5cm}
\end{wrapfigure}\leavevmode

## Introduction <img src="https://raw.githubusercontent.com/aravind-j/PGRdup/master/inst/extdata/PGRdup v2.png" align="left" alt="logo" width="173" height = "200" style = "padding: 10px; border: none; float: right;">
...
## Version History
The current version of the package is `r as.vector(available.packages()["PGRdup",]["Version"])`. The previous versions are as follows.
...
VerHistory <- XML::readHTMLTable(link)[[1]][,2:3]
...
print("package 'XML' is required to generate this table")
}
