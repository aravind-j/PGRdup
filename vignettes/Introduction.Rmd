...
## Version History
The current version of the package is `r getNamespaceVersion("PGRdup")`. The previous versions are as follows.
...
rownames(VerHistory) <- NULL
  ...
  VerHistory <- data.frame(Version = c("0.2", "0.2.1", "0.2.2", "0.2.2.1",
                                           "0.2.3", "0.2.3.1"),
                           Date = structure(c(16539, 16639, 16865,
                                              16869, 17198, 17240),
                                            class = "Date"))
}
