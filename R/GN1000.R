...
#'   columns(fields): \describe{ \item{CommonName}{Common name} 
#'   \item{BotanicalName}{Botanical name} \item{NationalID}{NBPGR National 
#'   identifier} \item{CollNo}{Collector number} \item{DonorID}{Donor ID} 
